...
public class Cat implements Player{
    ...
    public Cat(String name, Integer maxJump, Integer maxRun) {
        this.name = name;
    ...
    public void jump(Wall wall) {
        if (maxJump >= wall.getHeight()){
            System.out.println("Кот по имени " + name + " перепрыгнул стену высотой " +
                    wall.getHeight() + " метров");
        }
        else {
            System.out.println("Кот по имени " + name + " не перепрыгнул стену высотой " +
    ...
    public void run(Treadmill treadmill) {
        if (maxRun >= treadmill.getLength()){
            System.out.println("Кот по имени " + name + " пробежал растояние " +
                    treadmill.getLength() + " метров.");
        }
        else {
            System.out.println("Кот по имени " + name + " не пробежал растояние " +
    ...
    @Override
    public void getInfo() {
        System.out.println("Кот по имени " + name + " может прыгать на высоту " +
